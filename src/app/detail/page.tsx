        ...
        <div className="pt-5 col-span-8 py-15">
          ...
          <div className="py-4 border-b">
            ...
            <div className=" grid gap-2 grid-cols-8 py-3">
              <div className=" text-sm text-shadow text-white font-semibold bg-opacity-75 bg-black p-3 text-uppercase rounded-md text-center">
                <p>Cấp 1</p>
              </div>
              <div className="text-sm text-shadow text-white font-semibold bg-opacity-75 bg-black p-3 text-uppercase rounded-md text-center">
                <p>Cấp 2</p>
          ...
          <div className="py-4 border-b">
            ...
            <div className="pt-2">
              ...
              <div className="pt-2 col-span-3 text-zinc-950 ">
                ...
                <label>phương canh , xuân phương , nam từ liêm , hà nội</label>
              </div>
            </div>
          </div>
          <div className="py-4 border-b">
