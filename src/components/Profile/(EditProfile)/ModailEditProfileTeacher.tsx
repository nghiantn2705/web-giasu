...
export default function ModoalEditProfileTeacher({ editProfile }: IProps) {
  ...
  const onFinish = async (values: any) => {
    ...
    formData.append('salary_id', values.salary);
  ...
  return (
    <div>
      <div onClick={openModal}>
        {' '}
        <a className={'text-cyan-400 '}>Xem thêm thong tin và chỉnh sửa</a>
      </div>
                ...
                >
                  <div className={'grid grid-cols-2 gap-4'}>
                    ...
                    <Form.Item<FieldType>
                      name="phone"
                      rules={[
                        { required: true, message: 'Hãy số điện thoại!' },
                      ]}
                      className={'w-full'}
                    >
                      <Input
                      ...
                      rules={[
                        {
                          required: true,
                          message:
                            'Hãy điền vị trí công việc hiện tại của bạn!',
                        },
                      ]}
                      className={'w-full'}
                    >
